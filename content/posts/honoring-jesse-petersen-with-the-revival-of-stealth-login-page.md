---
title: "Honoring Jesse Petersen with the Revival of “Stealth Login Page”"
description: "The WordPress® community has always been defined by its people – the contributors, developers, and advocates who have shaped the ecosystem into what it is today. Among these individuals, Jesse Petersen stood out as a…"
custom_url: "honoring-jesse-petersen-with-the-revival-of-stealth-login-page"
author: "Robert DeVore"
date: "2025-01-09"
canonical: "https://robertdevore.com/honoring-jesse-petersen-with-the-revival-of-stealth-login-page/"
template: "signal-a"
nav_hide: true
excerpt: "The WordPress® community has always been defined by its people – the contributors, developers, and advocates who have shaped the ecosystem into what it is today. Among these individuals, Jesse Petersen stood out as a…"
...
Today, I am honored to announce a reimagined version of “[Stealth Login Page](https://github.com/robertdevore/stealth-login-page/)“, built with the same mission and heart as Jesse’s original plugin. 
...
![Stealth Login Page - Plugin Settings for WordPress®](/assets/legacy-images/stealth_login_page_settings.webp)

## What Is Stealth Login Page?

The “[Stealth Login Page](https://github.com/robertdevore/stealth-login-page)” plugin provides a robust layer of security for WordPress® sites by locking down access to the `wp-admin` and `wp-login.php` pages. 

Only users who pass a secret `auth_key` parameter in the URL are granted access. 
...
![Snoop Dogg - Thumbs up GIF](/assets/legacy-images/snoop_thumbs_up.webp)
...
The reimagined “Stealth Login Page” plugin is now available for download [on GitHub](https://github.com/robertdevore/stealth-login-page/). 

Here’s how to get started:

  1. **Download and Install** : Upload the plugin folder to your WordPress® site under `wp-content/plugins/`.
  2. **Activate and Configure** : Go to **Settings > Stealth Login Page** to enable the plugin, set your `auth_key`, and customize the redirect URL.
  3. **Secure Your Site** : Share the `auth_key` securely with trusted users to lock down your admin access.
...
If you’ve been inspired by Jesse’s work or want to contribute, I encourage you to join the project on [GitHub](https://github.com/robertdevore/stealth-login-page/) or share your thoughts on how we can improve the plugin further.
