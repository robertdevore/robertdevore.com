---
title: "Introducing IntelliPress: The Smart Ai Assistant for WordPress"
description: "The last time I was this excited to announce a new baby, it was my son 😂 Today I’d like to formally introduce you to IntelliPress , an AI WordPress plugin that integrates with the OpenAI API . It’s built to help you…"
custom_url: "introducing-intellipress-the-smart-ai-assistant-for-wordpress"
author: "Robert DeVore"
date: "2023-05-31"
canonical: "https://robertdevore.com/introducing-intellipress-the-smart-ai-assistant-for-wordpress/"
template: "signal-b"
nav_hide: true
excerpt: "The last time I was this excited to announce a new baby, it was my son 😂 Today I’d like to formally introduce you to IntelliPress , an AI WordPress plugin that integrates with the OpenAI API . It’s built to help you…"
...
Today I’d like to formally introduce you to [IntelliPress](https://intellipress.robertdevore.com/), an AI WordPress plugin that integrates with the [OpenAI API](https://openai.com/product).

It’s built to help you write content faster, optimize it for search engines, generate featured images from [Pexels](https://pexels.com), and more.

![](/assets/legacy-images/1500x500_3_1024x341.webp)

_[ChatGPT](http://chat.openai.com) hit the scene and changed everything._
...
> [pic.twitter.com/sdWoxxy83t](https://t.co/sdWoxxy83t)
> 
> — Robert DeVore (@deviorobert) [May 10, 2023](https://twitter.com/deviorobert/status/1656120430581694464?ref_src=twsrc%5Etfw)

When you look at the Twitter thread, you’ll see I was up until after 4am that night.

_I was genuinely inspired._

It’s the first time in years that I’ve had that feeling. 

The last time was when I launched [WP Dispensary](https://www.wpdispensary.com) in 2015 (more on that another day).
...
Head over to the [IntelliPress](https://intellipress.robertdevore.com/) website and grab your copy today so you can start revolutionizing your content creation process 💪💯
