---
title: "Introducing Table Block Enhancer for WordPress®"
description: "Today I’m happy to announce the release of a new free plugin for WordPress® called Table Block Enhancer 🚀 This WordPress® plugin designed to supercharge the default WordPress® Table block, which is lacking in features…"
custom_url: "introducing-table-block-enhancer-for-wordpress"
author: "Robert DeVore"
date: "2024-12-04"
canonical: "https://robertdevore.com/introducing-table-block-enhancer-for-wordpress/"
template: "signal-c"
nav_hide: true
excerpt: "Today I’m happy to announce the release of a new free plugin for WordPress® called Table Block Enhancer 🚀 This WordPress® plugin designed to supercharge the default WordPress® Table block, which is lacking in features…"
...
Today I’m happy to announce the release of a new free plugin for WordPress® called **[Table Block Enhancer](https://github.com/robertdevore/table-block-enhancer/)** 🚀
...
![Table Block Enhancer - Frontend sorting example](/assets/legacy-images/table_block_enhancer_frontend_display.webp)
...
It’s also a request in the Gutenberg GitHub repo that’s been active since 2022 👀 ([source](https://github.com/WordPress/gutenberg/issues/39398))
...
That’s why I developed [Table Block Enhancer](https://github.com/robertdevore/table-block-enhancer/) – to fill this gap and give WordPress® users the power to create dynamic, interactive tables with ease.

![Table Block Enhancer - editor settings](/assets/legacy-images/table_block_enhancer_editor_settings_1024x579.webp)
...
![](/assets/legacy-images/table_block_enhancer_frontend_display.webp)
...
![Snoop GIF - this month is gonna be craaaaaazy ya dig?](/assets/legacy-images/snoop_this_month.webp)

I’m excited to share **Table Block Enhancer** with the WordPress® community as part of my [December to Remember](https://twitter.com/deviorobert/status/1863085624028438544) initiative.

I believe it fills a vital need for more dynamic and interactive tables within the Gutenberg editor.

Go ahead and [download the plugin](https://github.com/robertdevore/table-block-enhancer/), give it a try, and let me know what you think 🙏💯
...
**Newer:** [Introducing Media File Versioning for WordPress®](/introducing-media-file-versioning-for-wordpress/)

**Older:** [Introducing Purchase Orders for WooCommerce® (free)](/introducing-purchase-orders-for-woocommerce-free/)
