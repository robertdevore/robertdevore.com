...
description: "I have been mostly quiet online for the last year. A lot of life fit inside the quiet silence. Most importantly, I gave myself room to think."
custom_url: "forever-forward"
author: "Robert DeVore"
date: "2026-08-08"
canonical: "https://robertdevore.com/forever-forward/"
template: "signal-a"
nav_hide: true
...
I came out of that time with [Kujo](https://kujolang.ai).

Kujo is a programming language, but the language itself is only one piece of what I have been building.

It is the open foundation for a larger [ecosystem](https://kujolang.ai/ecosystem/) focused on AI-native development, trustworthy automation, and giving people real control over the autonomous systems working on their behalf.
...
I have always believed that open source is [anarchism in action](https://robertdevore.com/open-source-is-anarchism-in-action/).
...
[Kujo](https://kujolang.ai) is being built for the layer around that production.
...
[Kujo](https://kujolang.ai) sits above and around the work, giving it structure that remains understandable as more of the execution moves from people to agents.
...
They are [leadership](https://robertdevore.com/leap-the-code-of-extreme-leadership/) problems.
...
[Kujo](https://kujolang.ai) is where those ideas become functional.
...
I do not want [Kujo](https://kujolang.ai) to work that way.
...
[Kujo](https://kujolang.ai) is moving into public view.
...
- [Open Source is Anarchism in Action](/open-source-is-anarchism-in-action/)
- [LEAP: The Code of Extreme Leadership](/leap-the-code-of-extreme-leadership/)
- [Do Less, Deliver More](/do-less-deliver-more/)
