---
title: "Introducing Markdown Exporter for WordPress®"
description: "This month has been a whirlwind of development and releases, and today continues that tradition. I’m happy to proudly release my 7th free plugin this month 🔥 Each plugin represents a step forward in enhancing your…"
custom_url: "introducing-markdown-exporter-for-wordpress"
author: "Robert DeVore"
date: "2024-11-12"
canonical: "https://robertdevore.com/introducing-markdown-exporter-for-wordpress/"
template: "signal-b"
nav_hide: true
excerpt: "This month has been a whirlwind of development and releases, and today continues that tradition. I’m happy to proudly release my 7th free plugin this month 🔥 Each plugin represents a step forward in enhancing your…"
...
Each plugin represents a step forward in enhancing your WordPress® experience, and today, I’m thrilled to introduce one that holds a special place in my heart: **[Markdown Exporter for WordPress®](https://github.com/robertdevore/markdown-exporter-for-wordpress/)**.

![Markdown Exporter Settings Screenshot](/assets/legacy-images/markdown_exporter_settings_with_log.webp)Markdown Exporter Settings

## Why _Another_ Plugin?
...
It’s also a side quest that I got the idea for when I seen a conversation about it [on Twitter](https://x.com/thekevingeary/status/1856073318463590835).

But mostly it’s because of all the other reasons I listed first 😂

## Introducing Markdown Exporter for WordPress®

**[Markdown Exporter for WordPress®](https://github.com/robertdevore/markdown-exporter-for-wordpress/)** is designed to seamlessly convert your WordPress posts, pages, and custom content types into well-structured Markdown (MD) files.
...
![](/assets/legacy-images/cool.webp)
...
![Stattic - Decentralized Publishing](/assets/legacy-images/stattic_decentralized_publishing.webp)

## Seamless Integration with Stattic

One of the standout features of Markdown Exporter is its compatibility with **[Stattic](https://stattic.site/)** , the static site generator I’ve been building over the last month or so. 
...
![Schitts Creek - I'm listening GIF](/assets/legacy-images/schitts_creek_im_listening.webp)

## Getting Started

### Installation

  1. **Download the Plugin** : Visit the [GitHub repository](https://github.com/robertdevore/markdown-exporter-for-wordpress/) to download the latest version of Markdown Exporter.
...
As someone who built [Stattic](https://github.com/getstattic/stattic/), I understand the importance of having a smooth and reliable way to transition content from WordPress® to a static site environment. 

And while I built a [Python script](https://github.com/getstattic/autoStattic) that does the same thing, this plugin bridges that gap for those who are not as technically savvy, making the process intuitive and efficient.
...
Here’s how you can get involved:
  ...
  * **Provide Feedback** : Your insights are invaluable. Share your experiences, report any issues, or suggest features by opening an issue on the [GitHub repository](https://github.com/robertdevore/markdown-exporter-for-wordpress/issues).
...
Explore more at [stattic.site](https://stattic.site/) and stay connected through the [GitHub repository](https://github.com/getstattic/stattic/).
