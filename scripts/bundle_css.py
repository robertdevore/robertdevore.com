...
.home-page>.signal-hero .signal-hero__inner{text-align:center}.home-page>.signal-hero .signal-title,.home-page>.signal-hero .signal-kicker,.home-page>.signal-hero .signal-lede,.home-page>.signal-hero .signal-actions{margin-right:auto;margin-left:auto}.home-page>.signal-hero .signal-title{-webkit-text-stroke:8px #fff}
